 ...
 * it to a buffer containde in a struct.
...
/**
 * convert_o - Converts an unsigned int to octal and stores
 ...
 * @prec: A precision modifier.
 * @len: A length modifier.
 * @output: A buffer_t struct containing a character arrey.
 *
 * Return: The number of bytes stored to the buffer.
 */
...
/**
 * convert_u - Converts an unsigned int argument to decimal and stores
 * it to a buffer contained in a struct.
 * @args: A va_list pointing to the argument to be converted.
 * @flags: Flag modifiers.
 * @wid: A width modifier.
